...
class LCA():
    ...
    def __init__(
        ...
        ----------
        n_units : int
            the number of accumulators in the LCA, one accumulator per 
            memory stored in EM. 
        dt_t : float
        ...
        self.w_input = w_input # this is the EM gate value 
        self.w_cross = w_cross # generally set to 0
        self.offset = offset
    ...
    def run(self, stimuli):
        ...
        the update formula:
            1. Let x_i be the cosine similarity for c_t and m_i. Multiply 
            x_i by EM_gate value (alpha in paper)
        ...
        # Step 1
        inp = torch.matmul(stimuli, self.W_i) # shape T x n_units
        ...
        for t in range(T):
            ...
            # constrain EM weights to be greater than 0 and less than 1 
